...
| 参数名               | 类型   | 说明                                        |
| -------------------- | ------ | ------------------------------------------- |
| `user_withdrawal_id` | string | 商户订单号（即您提交代付时的 `df_sn`）      |
| `withdrawal_address` | string | 提现收款地址                                |
| `currency_amount`    | string | 提现金额（保留两位小数，例如 `100.00`）     |

### 请求示例

```json
{
    "user_withdrawal_id": "D20260613100001",
    "withdrawal_address": "TXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
